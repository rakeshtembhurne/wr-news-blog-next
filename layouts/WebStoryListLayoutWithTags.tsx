...
import type { WebStory } from 'contentlayer/generated'
...
interface ListLayoutProps {
  webStories: CoreContent<WebStory>[]
  title: string
  initialDisplayPosts?: CoreContent<WebStory>[]
...
export default function WebStoryListLayoutWithTags({
  webStories,
  title,
  initialDisplayPosts = [],
  pagination,
  ...
  const displayPosts = initialDisplayPosts.length > 0 ? initialDisplayPosts : webStories
